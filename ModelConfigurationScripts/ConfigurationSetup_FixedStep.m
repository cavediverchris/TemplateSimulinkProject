%---------------------------------------------------------------------------
%  MATLAB function for configuration set generated on 28-May-2014 16:29:21
...
cs.set_param('ModelReferenceMinAlgLoopOccurrences', 'on');   % Minimize algebraic loop occurrences 
...
cs.set_param('StopTime', '0.00833');   % Stop time 
...
% cs.set_param('FcnCallInpInsideContextMsg', 'EnableAllAsWarning');   
...
%cs.set_param('CodeReplacementLibrary', 'Intel IPP');   % Code replacement library 
%cs.set_param('CodeReplacementLibrary', 'Intel IPP for x86-64 (Windows)');   % Code replacement library 
%cs.set_param('CodeReplacementLibrary', 'Intel IPP for x86/Pentium (Windows)');   % Code replacement library 
