%---------------------------------------------------------------------------
%  MATLAB function for configuration set generated on 27-May-2016 08:02:41
%  MATLAB version: 8.3.0.532 (R2014a)
%---------------------------------------------------------------------------

function cs=ConfigurationSetup_FixedStep()
...
cs.set_param('ProdHWDeviceType', 'Freescale->32-bit PowerPC');   % Device type 
...
% Solver pane
cs.set_param('FixedStep', '0.00833');   % Fixed-step size (fundamental sample time) 
...
cs.set_param('StopTime', '10*0.00833');   % Stop time 
...
cs.set_param('ReadBeforeWriteMsg', 'DisableAll');   % Detect read before write 
...
cs.set_param('WriteAfterReadMsg', 'DisableAll');   % Detect write after read 
cs.set_param('WriteAfterWriteMsg', 'DisableAll');   % Detect write after write 
...
cs.set_param('ProdLongLongMode', 'off');   % Enable long long 
...
cs.set_param('ObjectivePriorities', {'Execution efficiency','MISRA-C:2004 guidelines'});   % Prioritized objectives 
...
cs.set_param('MaxIdLength', 63);   % Maximum identifier length 
...
cs.set_param('GenerateAllocFcn', 'off');   % Generate function to allocate model data 
